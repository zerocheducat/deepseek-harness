...
export const zh = {
  ...
  'delete.session': '删除会话',
  'delete.session.desc': '将永久删除会话“{name}”的会话记录，并从 DeepSeek Harness 中移除该会话。工作区文件不会被删除。此操作无法撤销。',
...
export const en = {
  ...
  'delete.session.desc': 'This permanently removes the session log for “{name}” from DeepSeek Harness. Workspace files are kept. This action cannot be undone.',
