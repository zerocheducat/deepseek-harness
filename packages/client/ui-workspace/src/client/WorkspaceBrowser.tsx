...
> & {
  ...
  /** Open the browser-owned permanent session-delete confirmation dialog. */
...
export function WorkspaceBrowser({
  ...
  // Permanent session deletion is destructive, so unlike archive it always
  // passes through a browser-owned confirmation dialog. The Host removes the
  // persisted session log and Workspace/archive references, but never touches
